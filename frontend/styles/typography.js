...
@font-face {
  font-family: 'basis-grotesque-regular';
    ...
    src: url('../static/fonts/basis-grotesque-regular.eot?#iefix') format('embedded-opentype'),
...
@font-face {
  ...
  src: url('../static/fonts/basis-grotesque-italic.eot?#iefix') format('embedded-opentype'),
...
const fontFamily = `'basis-grotesque-regular', georgia, verdana, sans-serif;`
